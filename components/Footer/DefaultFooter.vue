<template>
  ...
  <footer class="bg-white dark:bg-gray-900">
    <div class="container px-6 pt-12 pb-0 mx-auto">
      <div
      ...
      >
        ...
        <div>
          <p class="font-semibold text-gray-800 dark:text-white">Socials</p>

          <div class="flex flex-col items-start mt-5 space-y-2">
            <a
              href="#"
              class="text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400 flex"
              aria-label="Reddit"
            >
              <svg
