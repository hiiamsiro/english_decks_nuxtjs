<template>
  <v-modal name="DeleteCardModal">
    <div
      id="popup-modal"
      tabindex="-1"
      class="top-0 left-0 right-0 z-50 p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full"
    >
...
export default {
  methods: {
    closeModal() {
      this.$modal.close({ name: 'DeleteCardModal' })
    },
    onDelete(deckData) {
